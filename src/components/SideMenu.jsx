function SideMenu({ menuOpen }) {
  return (
    <div className={`auto-rows-min bg-black grid items-center fixed min-w-[228px] overflow-auto right-0 top-20 h-full transform transition duration-500 translate-x-full z-50  ${menuOpen ? 'transform-none' : ''}`}>
